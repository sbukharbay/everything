//
//  EmploymentStatusCoordinator.swift
//  AffordIQUI
//
...
class EmploymentStatusCoordinator: NSObject {
...
extension EmploymentStatusCoordinator: Coordinator {
    func start() {
        if let presenter = presenter {
            let viewController = EmploymentStatusViewController()
