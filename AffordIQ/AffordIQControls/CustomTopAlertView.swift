...
//  AffordIQControls
//
//  Created by Sultangazy Bukharbay on 21.10.2021.
...
public final class CustomTopAlertView: UIView {
    ...
    public init(title: String, icon: UIImage? = nil, message: NSMutableAttributedString, buttonTitle: String, buttonAction: (() -> Void)?) {
    ...
    private func setupViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            messageLabel.topAnchor.constraint(equalTo: topStackView.bottomAnchor, constant: 40),
